...
const API_URL = "MASUKKAN_URL_WEB_APP_GAS_ANDA_DISINI";
...
const gasFunctions = [
    'login', 'getKelasList', 'getMonitoringRealtime', 'getAbsensiToday',
    'getAppConfig', 'saveAppConfig', 'getHariLibur', 'updateHariLibur',
    'addHariLibur', 'deleteHariLibur', 'getSiswaList', 'getGuruList',
    'updateSiswa', 'addSiswa', 'getAbsensiList', 'generateExcel',
    'updateAbsensiStatus', 'updateGuru', 'addGuru', 'deleteSiswa',
    'deleteGuru', 'scanAbsensi'
];
